{
  ...
  function plugin() {
    ...
    Diapo.addPlugin('nav', {
      afterRender: function(diapo) {
        diapo.container.insertAdjacentHTML('beforeend', '<nav class="diapo-nav" style="position:fixed;z-index:999;bottom:1em;right:1em;color:rgba(200,200,200,0.3);font-size:2em;cursor:pointer;"><a data-dir="prev" class="fa fa-chevron-left"></ a> <a data-dir="next" class="fa fa-chevron-right"></ a></nav>');
